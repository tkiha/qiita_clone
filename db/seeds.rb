...
items = Item.create([
                        { user: users.first, title: 'タイトル1', content: "あああああああああ\r\n\r\n- a\r\n- a\r\n- a\r\n\r\n> あああああああああああ\r\n\r\n# a\r\n\r\n## aa\r\n\r\n### aaa\r\n\r\n*aaaaaaa*\r\n\r\n**aaaaaaaa**\r\n\r\n`aaaaaaaaaaaaa`\r\n\r\n```\r\naaaaaaaaaaa\r\n````\r\n" },
                        { user: users.first, title: 'タイトル2', content: "# 投稿2" },
                        { user: users.first, title: 'タイトル3', content: "# 投稿3" },
                        { user: users.second, title: 'タイトル4', content: "# 投稿4" },
                        { user: users.second, title: 'タイトル5', content: "# 投稿5" },
                        { user: users.second, title: 'タイトル6', content: "# 投稿6" },
                    ])
